...
export function extractOwnerOfCourseContentByResourceField<T>(serviceFunction: (resourceId: number, courseId: number) => Promise<T>, extractOwnerId: (resource: T) => string, resourceIdParam: string) {
    return async function (req: Request, res: Response, next: NextFunction) {
