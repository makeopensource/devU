...
export async function mockContainerCheckAnswer(file: string, containerAutoGrader: ContainerAutoGrader) {
  ...
  gradeResults.push({
    score: 5,
    feedback: 'Grader #' + containerAutoGrader.id + ' graded ' + file + ' problem 1 for 5/5 points',
  })

  //SubmissionProblemScore 2
  gradeResults.push({
    score: 5,
    feedback: 'Grader #' + containerAutoGrader.id + ' graded ' + file + ' problem 2 for 5/5 points',
  })

  //SubmissionProblemScore 3
  gradeResults.push({
    score: 10,
    feedback: 'Grader #' + containerAutoGrader.id + ' graded ' + file + ' problem 3 for 10/10 points',
  })
