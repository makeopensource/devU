...
export class AssignmentAttachment1728881406096 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "assignments" DROP COLUMN "etags"`);
        await queryRunner.query(`ALTER TABLE "assignments" DROP COLUMN "filenames"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "assignments" ADD "filenames" text array NOT NULL DEFAULT '{}'`);
        await queryRunner.query(`ALTER TABLE "assignments" ADD "etags" text array NOT NULL DEFAULT '{}'`);
    }
