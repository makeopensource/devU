...
export class entityFixUp1708215731032 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "category" ("id" SERIAL NOT NULL, "course_id" integer NOT NULL, "name" character varying(128) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_9c4e4a89e3674fc9f382d733f03" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "courseScore" ("id" SERIAL NOT NULL, "course_id" integer NOT NULL, "user_id" integer NOT NULL, "score" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_6abff3c90b96cef828a38135c7f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "nonContainerAutoGrader" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "assignment_id" integer NOT NULL, "question" character varying(128) NOT NULL, "score" integer NOT NULL, "correct_string" character varying(128) NOT NULL, CONSTRAINT "PK_e4bee0253f704dad3db68b60df7" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "category" ADD CONSTRAINT "FK_becefa4788db15281f585822095" FOREIGN KEY ("course_id") REFERENCES "courses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "courseScore" ADD CONSTRAINT "FK_6b89c87198bb05ada5900364ac8" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "nonContainerAutoGrader" ADD CONSTRAINT "FK_7f4461171c55020ab0680ecbcd0" FOREIGN KEY ("assignment_id") REFERENCES "assignments"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."assignments_grading_type_enum" AS ENUM('code', 'non-code', 'manual')`);
